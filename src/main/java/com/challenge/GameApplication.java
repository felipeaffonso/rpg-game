...
public class GameApplication {
    ...
    public MainMenu setup(final FileUtils fileUtils) {
        ...
        final GameEngine gameEngine = new GameEngine(duringGameActionFactory, inputUtils, fileUtils);

        return new MainMenu(menuActionFactory, gameEngine, inputUtils, fileUtils);
    }
}
